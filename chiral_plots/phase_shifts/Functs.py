...
def alphas(irrep,dd):
  ...
  if irrep=='A1' and dd==1:
    alpha0=[2.0/sqrt(5.0),0]

  if irrep=='E2' and dd==1:
    alpha0=[-1.0/sqrt(5.0),0]

  if irrep=='A1' and dd==4:
    alpha0=[2.0/sqrt(5.0),0]

  if irrep=='E2' and dd==4:
    alpha0=[-1.0/sqrt(5.0),0]

  if irrep=='A1' and dd==2:
    alpha0=[-1.0/sqrt(5.0),-I*sqrt(6.0/5.0)]

  if irrep=='B1' and dd==2:
    alpha0=[-1.0/sqrt(5.0),I*sqrt(6.0/5.0)]	

  if irrep=='B2' and dd==2:
    alpha0=[2.0/sqrt(5.0),0]

  if irrep=='A1' and dd==3:
    alpha0=[0,-2.0*I*sqrt(6.0/sqrt(5.0))]

  if irrep=='E2' and dd==3:
